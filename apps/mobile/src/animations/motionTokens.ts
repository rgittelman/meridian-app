...
export const springConfig = {
  ...
  /** Swipe card returning to rest — weighted, satisfying settle */
  cardReturn: { damping: 22, stiffness: 220, mass: 1.0 },
  /** Card committing an action — slightly snappier exit */
  cardSettle: { damping: 18, stiffness: 180, mass: 0.85 },
  /** Bottom sheet open / close */
  sheet:      { damping: 26, stiffness: 280, mass: 0.85 },
} as const;
